...
#
# Calculate the screened Coulomb potential reduced impact parameter.
#
...
function th = screened_coulomb_ip(e,s,screening)

ne = length(e);
ns = length(s);

if (ne>1) && (ns>1) && (ne!=ns)
  error("screened_coulomb_ip: 1st and 2nd args different number of elements");
endif
...
if !ischar(screening),
  error("screened_coulomb_ip: 3rd arg must be a string");
endif
...
if k<0,
  error("screened_coulomb_ip: 3rd arg is not a valid screening type");
endif

th = __screened_coulomb_ip__(e,s,k);
