...
Follow the instructions for building OpenTRIM on Linux on the previous link,
on the line below "for the GUI component add the following".
...
Run the xlauncher and create configuration with the following parameters (there is a text input box at the end of the wizard):
