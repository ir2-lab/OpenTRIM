# -*- texinfo -*-
# @deftypefn {Function File} {@var{s}=} screened_coulomb_sn (@var{e}, @var{theta}, @var{screening})
# @deftypefnx {Function File} {@var{s}=} screened_coulomb_sn (@var{e}, @var{theta})
#
# Calculate the screened Coulomb potential reduced nuclear stopping cross-section.
#
...
# The default is "ZBL"
#
# @seealso{screened_coulomb_theta, screened_coulomb_xs, screened_coulomb_ip}
# @end deftypefn
#

function th = screened_coulomb_sn(e,s,screening)

ne = length(e);
ns = length(s);

if (ne>1) && (ns>1) && (ne!=ns)
  error("screened_coulomb_sn: 1st and 2nd args different number of elements");
endif
...
if !ischar(screening),
  error("screened_coulomb_sn: 3rd arg must be a string");
endif
...
if k<0,
  error("screened_coulomb_sn: 3rd arg is not a valid screening type");
endif

th = __screened_coulomb_sn__(e,s,k);
