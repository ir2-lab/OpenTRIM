...
int mcconfig::validate(bool AcceptIncomplete, std::ostream *os) const
{
    ...
    for (int i = 0; i < int(UserTally.size()); ++i) {
        ...
        path += "/bins/";
        bool reti = ff(ut.bins.x, path + "x", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.y, path + "y", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.z, path + "z", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.r, path + "r", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.rho, path + "rho", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.cosTheta, path + "cosTheta", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.nx, path + "nx", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.ny, path + "ny", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.nz, path + "nz", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.E, path + "E", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.Tdam, path + "Tdam", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.V, path + "V", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.atom_id, path + "atom_id", nbins);
        ret = ret && reti;
        reti = ff(ut.bins.recoil_id, path + "recoil_id", nbins);
        ret = ret && reti;
